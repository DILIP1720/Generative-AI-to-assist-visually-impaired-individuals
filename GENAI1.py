...
GEMINI_API_KEY = config.GEMINI_API_KEY # Replace with your valid API key
...
st.markdown('<div class="main-title"> FocusAI </div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle"> ✯ AI Assistant for Visually Impaired ✯ </div>', unsafe_allow_html=True)
